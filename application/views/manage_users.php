...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#example').DataTable( {
            ...
            "ajax":{
                url : '<?php echo base_url(); ?>Users/get_user_data', // json datasource
    ...
    function delete_user(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Users/delete_user_data",
    ...
    function delete_single_user(single_id){
        swal({
            ...
            function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Users/delete_single_user_data",
    ...
    function status(single_id){
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>Users/update_user_status",
            data: {data_id: single_id},
            success: function (result) {
                var oTable1 = $('#example').DataTable();
                oTable1.ajax.reload(null, false);
    ...
    $('#multi_delete').click(function () {
        var abc = ($('input[type="checkbox"]:checked').map(function() {
            return this.value;
        }).get().join(', '));
        swal({
                title: "Are you sure?",
            ...
            function () {
                swal("Deleted!", "Your imaginary file has been deleted.", "success");
                $.ajax({
                    'url':'<?php echo base_url('Users/mul_del'); ?>',
                    'data':{'id':abc},
                    'method':'get',
                    success: function(result) {

                        var table_review = $('#example').DataTable();
