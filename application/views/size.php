                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> Manage Sizes</span>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <div class="btn-group pull-right">
                                                <button class="btn red"  onclick="window.location.href='<?php echo base_url('Add_Size'); ?>'"> <i class="glyphicon glyphicon-plus"></i>Add
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#example').DataTable( {
            ...
            "ajax":{
                url : '<?php echo base_url(); ?>Size/get_size_data', // json datasource
    ...
    function delete_user(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Size/delete_size_data",
    ...
    function delete_single_user(single_id){
        swal({
            ...
            function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Size/delete_single_size_data",
    ...
    function status(single_id){
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>Size/update_user_status",
            data: {data_id: single_id},
            success: function (result) {
                var oTable1 = $('#example').DataTable();
                oTable1.ajax.reload(null, false);
