                                ...
                                <div style="margin: 20px 0 10px 30px">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-6 text-stat">
                                            <span class="label label-sm label-success"> Order: </span>
                                            <h3 id="order" >0</h3>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-6 text-stat">
                                            <span class="label label-sm label-info"> Revenue: </span>
                                            <h3 id="order_data" >0</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    function order_lay(id) {
        $.ajax({
            ...
            'success': function (data) {
                ...
                //alert(obj_o.total_g);
                $("#order").html(obj_o.total_o);
                if(obj_o.total_r != null ) {
                    $("#order_data").html(obj_o.total_r + '$');
                }
            }
        });
    }
