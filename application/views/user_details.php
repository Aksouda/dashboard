        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    ...
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            <button type="button" class="btn red btn-sm btn-outline dropdown-toggle"
				...
				$id=base_url(uri_string());
                            $link_array = explode('view_user/',$id);
                            $user_id = end($link_array);
                            $query = $this->db->get_where('app_user', array('u_id' => $user_id));
                            $row = $query->row_array();
                            //print_r($row);
                            ?>
                                    ...
                                    <form role="form">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" id="form_control_coupon_code" value="<?php echo $row['name'];?>">
                                                        <label for="form_control_coupon_code">User Name : </label>
                                                        <span class="help-block">Some help goes here...</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" id="form_control_no_of_token" value="<?php echo $row['email'];?>">
                                                        <label for="form_control_no_of_token">Email: </label>
                                                        <span class="help-block">Some help goes here...</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" id="form_control_coupon_code" value="<?php echo $row['phone_number'];?>">
                                                        <label for="form_control_coupon_code">Phone Number: </label>
                                                        <span class="help-block">Some help goes here...</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" id="form_control_no_of_token" value="<?php echo $row['address'];?>">
                                                        <label for="form_control_no_of_token">Address: </label>
                                                        <span class="help-block">Some help goes here...</span>
                                                    </div>
                                                </div>
                                            </div>
