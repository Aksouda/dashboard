        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
				...
				$id=base_url(uri_string());
                            $link_array = explode('View_Size/',$id);
                            $size_id = end($link_array);
                            $query = $this->db->get_where('size', array('size_id' => $size_id));
                            $row = $query->row_array();
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="size_name" required value="<?php echo $row['name'];?>">
...
<script>
    $('.<?php echo $row['category_id']; ?>').attr('selected','selected');
</script>
<style type="text/css">
