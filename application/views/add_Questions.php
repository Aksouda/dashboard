            ...
            <div class="page-content">
                ...
                <div style="background-color: white;padding: 25px;padding-top: 0px;" >
                    ...
                    <div style="background-color: white;padding: 25px;">
                        ...
                        <form method="post" id="review" action="<?php if(isset($update)){echo base_url('Questions/update/').$update[0]['faq_id'];}else{echo base_url('Questions/add_new');}?>">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" id="name" name="Question" value="<?php if(isset($update)){ echo $update[0]['question'];} ?>">
                                        <label for="form_control_pickup_address"> Question :</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <label for="form_control_pickup_address"> Answer :</label>
                                    <div class="form-group form-md-line-input form-md-floating-label">
