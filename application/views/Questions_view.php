                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <div class="btn-group pull-right">
                                                <button class="btn red"  onclick="window.location.href='<?php echo base_url('Questions/add'); ?>'"> <i class="glyphicon glyphicon-plus"></i>Add
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        $('#reviews').DataTable({
            "iDisplayLength": 10,
            ajax: '<?php echo base_url('Questions/get_data'); ?>',
            columns: [
                { data: "cheked"},
                { data: "question" },
                { data: "description" },
    ...
    function delete_review(id) {
        swal({
            ...
            function(){
                $.ajax({
                    'url':'<?php echo base_url('Questions/delete'); ?>',
                    'method':'POST',
                    'data':{'id':id},
                    'success':function(){
    ...
    $('#multi_delete').click(function (){
        ...
        swal({
            ...
            function () {
                swal("Deleted!", "Your imaginary file has been deleted.", "success");
                $.ajax({
                    'url':'<?php echo base_url('Questions/multi_delete'); ?>',
                    'data':{'id':abc},
                    'method':'post',
