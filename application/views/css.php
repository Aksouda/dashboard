...
<link href="<?php echo base_url('assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.standalone.css'); ?>" rel="stylesheet" type="text/css">
...
<link rel="shortcut icon" href="<?php echo base_url('assets/favicon.png') ?>" rel="shortcut icon" type="image/x-icon" /></head>
<link href="<?php echo base_url("assets/css/Loader_tom.css"); ?>" rel="stylesheet" type="text/css" />