    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR --><!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <div style="background-color: white;padding-left: 25px;padding-right: 25px;padding-top: -25px;" >
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <textarea class="form-control" id="summernote" name="des" ><?php echo (isset($r_data))?$r_data['description']:''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
