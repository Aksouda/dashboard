                        ...
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                            ...
                            <div class="portlet-body">
                                <div class="tab-pane active" id="tab_1">
                                    <form id="myform" role="form" method="post" name="valide_size" enctype="multipart/form-data" >
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div id="myclass_add" class="form-group form-md-line-input form-md-floating-label ">
                                                        <input type="text" class="form-control " onchange="same_name(this.value);" id="product_name" name="product_name">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <input type="number" class="form-control" id="srock" name="stock" value="" >
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    ...
                                                    &nbsp;&nbsp;<input type="radio" name="isProductCustomizable" value="0">&nbsp;&nbsp;Yes<br>
                                                    &nbsp;&nbsp;<input type="radio" name="isProductCustomizable" value="1" checked>&nbsp;&nbsp;No
                                                </div>
                                            </div>
                                        </div>
...
// echo json_encode($userdetail);
                                                                ...
                                                                function printTree($tree, $r = 0, $p = null)
                                                                {
                                                                    foreach ($tree as $i => $t)
                                                                    {
                                                                        ...
                                                                        printf("\t&nbsp;&nbsp;<input type='checkbox'  class='checkbox12' name='category_ids[]' value='$id' >&nbsp;&nbsp;<span value='%d'>%s%s</span>\n<br>", $t['id'], $dash, $t['name']);
                                                                        if ($t['parent_id'] == $p)
                                                                        {
// reset $r
                                                                            $r = 0;
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <fieldset class="scheduler-border">
                                                        ...
                                                        <div class="control-group">
                                                            <div class="row">
                                                                <input type="file" name="primary_image" id="primary_image" style="margin-left: 3%;" >
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <fieldset class="scheduler-border">
                                                        ...
                                                        <div class="control-group">
                                                            <div class="row">
                                                                <input type="file" name="primary_image1" style="margin-left: 3%;"><br>
                                                                <input type="file" name="primary_image2" style="margin-left: 3%;"><br>
                                                                <input type="file" name="primary_image3" style="margin-left: 3%;"><br>
                                                                <input type="file" name="primary_image4" style="margin-left: 3%;"><br>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="summernote" name="product_description" value="" required></textarea>
                                                </div>
                                                </div>
                                            </div>
                                        <br>
                                                                ...
                                                                <td>
                                                                    <label
                                                                        ...
                                                                        <input type="radio" class="checkboxes"
                                                                               name="brand_id" value="<?php echo $row['brand_id'];?> "/>
                                                                        <span></span>
                                                                    </label>
                                                                </td>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="col-sm-4 nopadding">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" id="attribute_name" name="attribute_name[]" value="" placeholder="name" >
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4 nopadding">
                                                                    <div class="form-group">
                                        ...
                                        <label><b>When you checked Save As draft the data will not display at user device.</b></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="submit" class="btn btn-primary" id="submit" name="save" onclick="return valid_form();" >
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    function testcheck()
    {
        if (!$('input[type="checkbox"]').is(":checked")) {
            sweetAlert("Oops...", "Please Select Atleast One Category!", "error")
            return false;
        }
        return true;
    }
    ...
    var name_checked;
    function same_name(data){
        $.ajax({
            'url':'<?php echo base_url('Add_Product/same_name'); ?>',
            'method':'post',
            'data':{'data':data},
